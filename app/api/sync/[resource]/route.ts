...
import { fetchCsvRows, csvNum, csvBool, csvStr } from "@/app/lib/sync";
...
const SHEET_URL_FIELD: Record<Resource, string> = {
...
async function syncResource(resource: Resource, rows: Record<string, string>[]): Promise<number> {
  switch (resource) {
    case "projects":
